...
const initialContent = {
  ...
  about: {
    intro:
      "Hey there! I'm Muhammad Ega, a Product Manager with a passion for creating innovative solutions that make a real difference. With a background in Electrical Engineering and Human-Computer Interaction, I bring a unique blend of technical know-how and user-centric design to every project I tackle.",
    journey:
      "My journey has taken me from Padjadjaran University in Indonesia to the University of Birmingham in the UK, and I've had the privilege of working with amazing teams at companies like Mekari, Shopee, and IBM. Every step of the way, I've been driven by a desire to create products that not only meet but exceed user expectations.",
    personal:
      "When I'm not knee-deep in product roadmaps or crunching data, you might find me strumming a guitar or exploring new coffee shops. I believe in the power of continuous learning and always strive to stay at the forefront of product management trends and technologies.",
    skills: [
      "Product Roadmapping",
  ...
  work: {
    intro:
      "Here are some of the key projects I've worked on. Each one represents a unique challenge and a significant achievement in my career as a Product Manager.",
    projects: [
      {
        title: "Mekari Sign",
        ...
        details:
          "As Product Manager for Mekari Sign, I worked with cross-functional teams to streamline user and team management processes, optimize API integration for enterprise clients, and drive significant revenue growth through strategic product development and market expansion initiatives.",
      },
      {
        title: "Shopee Seller",
        ...
        details:
          "Led product initiatives for seller growth and marketing tools, conducting extensive user research and implementing features that significantly improved seller satisfaction and platform adoption.",
      },
      {
        title: "IBM RPA",
        ...
        details:
          "Spearheaded the automation of high-volume tasks using IBM RPA and Python, leading a team of 4 to implement solutions that dramatically improved operational efficiency.",
      },
    ],
  },
  projects: [
    {
      ...
      details:
        "Vizzy is a powerful tool designed to streamline the process of report generation. It takes raw CSV data as input and automatically generates comprehensive, visually appealing reports. This project significantly reduces the time and effort required in data analysis and presentation.",
...
async function migrateToFirestore() {
  try {
    ...
    if (doc.exists) {
      // Merge with existing content to preserve other sections
      const existingData = doc.data()
      await docRef.set(
        {
          ...existingData,
          projects: initialContent.projects, // Update only the projects array
        },
        { merge: true },
      )
    } else {
      // If no document exists, create new one with all content
      await docRef.set(initialContent)
    }

    console.log("Projects content updated in Firestore successfully")
  } catch (error) {
